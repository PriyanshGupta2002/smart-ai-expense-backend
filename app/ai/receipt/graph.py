...
from app.ai.nodes.document_analysis_node import document_analysis_node
from app.ai.nodes.structure_node import structure_node
from app.ai.nodes.route_after_doc_analysis import route_after_document_analysis
...
graph.add_node("document_analysis_node", document_analysis_node)
graph.add_node("structure_node", structure_node)
# graph.add_node(
#     "layout",
#     layout_node,
# )
...
graph.add_edge("ocr_node", "document_analysis_node")

graph.add_conditional_edges(
    "document_analysis_node",
    route_after_document_analysis,
    {
        "simple": "extraction_node",
        "complex": "structure_node",
    },
)
...
#     },
# )
# graph.add_edge("structure_node", "extraction_node")
# # graph.add_edge("ocr_node", "layout")
# # graph.add_edge("ocr_node", "extraction_node")
